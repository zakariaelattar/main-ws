...
const rootRoute = require('./payments.route.js');
const paymentIdRoutes = require('./paymentId');
 ...
 *     description: Only admins can create other payments.
 *     tags: [Payments]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
